"""Regras de autenticação (signin + 2FA + recuperação de senha)."""
...
from users.models import PasswordResetChallenge, TwoFactorChallenge, User
...
def autenticar_signin(*, email: str, password: str) -> dict[str, Any]:
    """
